...
RSpec.describe NotificationMailer, type: :mailer do
  ...
  describe ".new_answer" do
    ...
    it { expect(subject.body).to match('Un nouveau message est disponible dans votre espace demarches-publiques.fr.') }
    ...
    it { expect(subject.subject).to eq("Nouveau message pour votre dossier demarches-publiques.fr nº #{dossier.id}") }
  end
end
